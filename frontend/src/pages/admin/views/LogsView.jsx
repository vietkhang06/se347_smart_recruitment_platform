  ...
  return (
    <Card className="matcha-card p-4 border-0 shadow-sm" data-aos="fade-up">
      <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        <div>
          <h5 className="fw-bold mb-0">Nhật ký kiểm toán & An ninh (Audit Logs)</h5>
          <p className="text-muted small mb-0">Theo dõi toàn bộ lịch sử tác động, thay đổi quyền hạn và thao tác quản trị</p>
        </div>
        <Button
      ...
      <div className="d-flex flex-wrap gap-2 mb-3">
        <div className="flex-grow-1" style={{ minWidth: 260 }}>
          <InputGroup size="sm">
            ...
            <Form.Control
              placeholder="Tìm theo hành động (APPROVE_JOB...), người thực hiện hoặc IP..."
              value={search}
            ...
            {filteredLogs.length === 0 ? (
              ...
              filteredLogs.map((l, i) => (
                <tr key={i}>
                  ...
                  <td>
                    <code className="text-primary fw-bold">{l.action}</code>
                  </td>
                  ...
                  <td>
                    <span className="badge bg-success bg-opacity-10 text-success">Thành công</span>
                  </td>
                </tr>
              ))
            )}
