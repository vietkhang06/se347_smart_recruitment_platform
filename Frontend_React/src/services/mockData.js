export const MATCHAJOB_MOCK = {
  employer: {
    ...
    funnel: {
      labels: ["Ứng tuyển", "Sàng lọc", "Bài test", "Phỏng vấn", "Nhận Offer"],
      counts: [148, 86, 42, 18, 5]
    },
    sources: {
      labels: ["MatchaJob", "LinkedIn", "Nội bộ giới thiệu", "Facebook", "Khác"],
      data: [48, 26, 14, 8, 4]
    }
  },
  admin: {
    ...
    growthStats: {
      ...
      users: [11200, 12800, 14100, 15900, 17100, 18240],
      jobs: [640, 780, 890, 1020, 1150, 1284]
    }
  }
};
